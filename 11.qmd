...
이 포인트들은 $[0,1]\times[0,1]$ 영역 내에 고르게 분포하고 있으며, 완전한 공간적 무작위 분포로도 표현할 수 있다. 그러나 영역의 크기가 커지면 ‘고르게 분포한다’고 말하기는 어려워 진다. 예를 들어, 아래 코드로 두 개의 정사각형 영역(`w1`과 `w2`)을 생성하는 예시를 보여준다(그림 11.1).
...
![두 포인트 패턴의 3 × 3 방격 빈도](https://r-spatial.org/book/11-PointPattern_files/figure-html/fig-quadrat-1.png){#fig-11-2}
