...
$R^2$에서는 $x$와 $y$ 좌표의 범위를 이용해 바운딩 박스를 쉽게 정의할 수 있지만, 타원체 좌표의 경우 지오메트리가 반대자오선(antimeridian)(경도 $\pm 180$)(역자주: 반대자오선은 본초자오선의 반대편에 위치한 자오선을 의미하는 것으로 동경 180도 혹은 서경 180도 경선을 지칭한다.) 이나 극점을 가로지를 때 이러한 범위는 크게 유용하지 않다.
